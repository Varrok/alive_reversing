...
void Paramite::Motion_0_Idle()
{
    ...
    else if (Input().IsPressed(sInputKey_GameSpeak1))
    {
...
s16 Paramite::NextPlayerInputMotion()
{
    ...
    else
    {
        ...
        {
            if (Input().IsHeld(sInputKey_ThrowItem | sInputKey_DoAction | sInputKey_GameSpeak5))
            {
                if (FindTarget())
                {
...
void Paramite::HandleInputRunning()
{
    ...
    else if (Input().IsHeld(sInputKey_Run))
    {
